...
registerBlockType('webentwicklerin/icon', {
  edit: ({
    ...
    return createElement(Fragment, null, createElement(InspectorControls, null, createElement(PanelBody, {
      title: __('Icon Settings', 'webentwicklerin'),
      initialOpen: true
      ...
      title: __('Link & Text', 'webentwicklerin'),
      initialOpen: false
      ...
      value: linkTarget,
      options: [{
        label: __('Gleiches Fenster', 'webentwicklerin'),
        value: '_self'
      }, {
        label: __('Neues Fenster', 'webentwicklerin'),
        value: '_blank'
      }],
      onChange: value => setAttributes({
        linkTarget: value,
      ...
      value: iconPosition,
      options: [{
        label: __('Links vom Text', 'webentwicklerin'),
        value: 'left'
      }, {
        label: __('Rechts vom Text', 'webentwicklerin'),
        value: 'right'
      }, {
        label: __('Über dem Text', 'webentwicklerin'),
        value: 'top'
      }, {
        label: __('Unter dem Text', 'webentwicklerin'),
        value: 'bottom'
      }],
      onChange: value => setAttributes({
        iconPosition: value
